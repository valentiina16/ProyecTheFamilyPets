...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div   class="container-fluid py-4 px-5 wow fadeIn"  style="height: 70px">
    ...
    <!-- Page Header Start -->
    <div style="margin: auto" class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <!-- Page Header End -->
    <div style="margin-left: 18%; width: 250px;  text-align: center">
        <form class="navbar-form">
            <div>
                <select name="tipo_masc" id="typeFilter" style="text-align: center">
    ...
    <div class="" style="margin-top: 5%; margin-left: 5%">
        ...
        @forelse($pet as $pet)
            ...
            <div  style="margin-top: 2%">
               <img class="img_adopt" style="margin-left: 25%; width: 35%" src="{{asset('img/fotos/'.$pet->foto_masc)}}">
               <p class="card-text1" style="margin-top: 5%"><b style="color: #000"> EDAD:</b> {{$pet->edad_masc}}</p>
                ...
                <p class="card-text1"><b style="color: #000">DESCRIPCION: </b>{{$pet->descripcion_masc}}</p>
